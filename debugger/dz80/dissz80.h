...
{
	unsigned char (*mem0Start)(void*,unsigned short);   /* Pointer to Z80 byte read function */
...
/* dZ80 private workspace stuff - hands off ;) */
	...
	unsigned char (*Z80MemBase)(void*,unsigned short);   /* Pointer to Z80 byte read function */

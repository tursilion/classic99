...
public:
	// used to be device-level overrides, now just methods
	void device_start(speechrom_device *pRom);
	void device_reset();
	void device_clock_changed();

protected:
	// I don't think I need these two...

//	void device_timer(emu_timer &timer, device_timer_id id, int param, void *ptr);
	// sound stream update overrides
//	void sound_stream_update(sound_stream &stream, std::vector<read_stream_view> const &inputs, std::vector<write_stream_view> &outputs);

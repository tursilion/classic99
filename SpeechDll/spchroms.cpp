...
static unsigned char *speechrom_data = NULL;	/* pointer to speech ROM data */
...
/*
	reset the speech ROMs (Tursi)
*/
void resetSpeechROMs() {
	speechROMaddr = 0;
	load_pointer = 0;
	ROM_bits_count = 8;
}
...
/*
	set the speech ROMs
*/
void spchroms_config(unsigned char* pROM, int nROMLen)
{
	if (NULL == pROM)
	{	/* no speech ROM */
		speechrom_data = NULL;
...
{
	// TODO: THIS SHOULD BE A SHIFT REGISTER, NOT A NIBBLE DROP.
	// BECAUSE OF THIS BEHAVIOUR, LOADING COUNTS OF ADDRESS OTHER
	// THAN 4 NIBBLES WILL NEVER WORK, BUT ON A SHIFT REGISTER THE
	// LAST FOUR WILL BE TAKEN. WE SHOULD VALIDATE ON THE REAL
	// MACHINE BUT I AM PRETTY SURE THAT'S GOING TO BE THE CASE.
